# This was a lesson in self-flagelation. Please read the comments from the bottom up..
# During my research, I came across an awesome description of classes in Python:
